...
test("repository docs describe Vera Solaro without stale single-page or legacy catalog guidance", () => {
  ...
  assert.match(
    docs.readme,
    /`aspt-midnight-ledger-vera-solaro` is the Midnight Ledger edition of the Vera Solaro astrology template/,
  );
...
test("lead documentation is an agent-ready integration reference", () => {
  ...
  assert.match(docs.leads, /wrangler d1 execute aspt-midnight-ledger-vera-solaro-site --local/);
