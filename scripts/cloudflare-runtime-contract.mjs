...
export const runtimeContract = {
  ...
  resources: {
    local: {
      workerName: "aspt-midnight-ledger-vera-solaro",
      d1DatabaseName: "aspt-midnight-ledger-vera-solaro-site",
      r2BucketName: "aspt-midnight-ledger-vera-solaro-media",
      kvNamespaceName: "LOCAL_ASPT_MIDNIGHT_LEDGER_VERA_SOLARO_SESSION_KV",
      emailQueueName: "aspt-midnight-ledger-vera-solaro-email",
      emailDeadLetterQueueName: "aspt-midnight-ledger-vera-solaro-email-dlq",
    },
    preview: {
      workerName: "aspt-midnight-ledger-vera-solaro-preview",
      d1DatabaseName: "aspt-midnight-ledger-vera-solaro-preview-site",
      r2BucketName: "aspt-midnight-ledger-vera-solaro-preview-media",
      kvNamespaceName: "aspt-midnight-ledger-vera-solaro-preview-session",
      emailQueueName: "aspt-midnight-ledger-vera-solaro-preview-email",
      emailDeadLetterQueueName: "aspt-midnight-ledger-vera-solaro-preview-email-dlq",
    },
    production: {
      workerName: "aspt-midnight-ledger-vera-solaro-production",
      d1DatabaseName: "aspt-midnight-ledger-vera-solaro-production-site",
      r2BucketName: "aspt-midnight-ledger-vera-solaro-production-media",
      kvNamespaceName: "aspt-midnight-ledger-vera-solaro-production-session",
      emailQueueName: "aspt-midnight-ledger-vera-solaro-production-email",
      emailDeadLetterQueueName: "aspt-midnight-ledger-vera-solaro-production-email-dlq",
    },
  },
