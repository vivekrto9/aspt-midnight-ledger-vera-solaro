...
// drawn Ledger plates from the seed asset store stand in: keyed by slug where a piece has its own
...
export const blogFallbackImages: BlogImage[] = [
  ...
  { src: "/_assets/aliases/blog-zodiac-wheel/blog-zodiac-wheel.svg", alt: "A twelve-house wheel printed in violet ink on ledger paper" },
...
export const blogImagesBySlug: Record<string, BlogImage> = {
  "saturn-is-not-punishing-you": {
    ...
    alt: "A ringed planet crossing a striped midnight sky",
  },
