...
const feature = "aspt-midnight-ledger-vera-solaro.project-assets.export";
...
export const POST: APIRoute = async (context) => {
  ...
  try {
    return jsonResponse({
      ...
      data: await buildAssetSnapshot({ env: auth.env, templateKey: "aspt-midnight-ledger-vera-solaro" }),
    });
  } catch (error) {
