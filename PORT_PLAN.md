# Vera Solaro architecture port record

Goal: booking, payment, account and email work exactly like
`aspt-western-single-astrologer` (base template). Public presentation now uses the Vera Solaro Midnight Ledger system.
...
rebuild nav as a Vera component, rewrite vera-public-content contracts.
